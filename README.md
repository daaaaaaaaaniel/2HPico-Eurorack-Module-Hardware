...
Solder the button. I glued the button cap on with a dab of superglue.

Solder the pots. I clipped the brackets near the bend to make soldering a bit easier but its not required. Make sure they are lined up vertically and horizontally before you solder the brackets to the pads. A Panavise is handy for this step.
...
Load up the ADSR app or mod the HWtest sketch so the I2S code is sending the value 0 to the DACs. Measure the level at the output jacks or at U6 pins 1 and 14 and trim to get as close to 0V as possible. There will probably be a few mv difference betweent the channels. 
